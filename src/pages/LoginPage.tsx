    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background via-primary/5 to-secondary/5 p-4">
      <div className="w-full max-w-[480px] animate-fade-in">
        ...
        <div className="bridge-card-elevated">
          ...
          <p className="text-center text-sm text-muted-foreground mb-6">Sign in to your teacher account</p>
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            ...
            <a href="#" className="text-primary hover:underline">Request access from your school administrator.</a>
          </p>
          <p className="mt-3 text-center text-[11px] text-muted-foreground">
            By signing in, you agree to Bridge's{" "}
