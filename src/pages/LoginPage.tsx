...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    // Mock auth: accept any non-empty credentials after 1.5s
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(135deg, #EDE9FF 0%, #FCE7F3 50%, #E0F2FE 100%)" }}
    >
      <div className="w-full max-w-[480px] animate-fade-in">
        ...
        <div className="flex items-center justify-center gap-2.5 mb-6">
          ...
          <span className="text-2xl font-extrabold" style={{ color: "#2D1B69" }}>
            Lila
          </span>
        </div>

        <div
          className="bg-white rounded-[28px] p-12"
          style={{ border: "1.5px solid #EDE9FF", boxShadow: "0 8px 48px rgba(167,139,250,0.18)" }}
        >
          <h2 className="text-center mb-1 font-extrabold" style={{ color: "#2D1B69" }}>
            Welcome back! 💜
          </h2>
          <p className="text-center text-sm mb-6" style={{ color: "#7C6FAA" }}>
            Sign in to your Lila teacher account
          </p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <button type="button" className="text-xs font-bold hover:underline" style={{ color: "#A78BFA" }}>
                  Forgot password?
                </button>
              </div>
          ...
          <button
            className="lila-btn-secondary w-full flex items-center justify-center gap-2 !border-[#EDE9FF]"
          ...
          <p className="mt-6 text-center text-xs" style={{ color: "#A89DC4" }}>
            ...
            <a href="#" className="font-bold hover:underline" style={{ color: "#A78BFA" }}>
